...
<jsp:include page="adminSideBar.jsp" />
    <div class="page-content">
        ...
        <%-- ORDERS EXIST — show cards + filter + table --%>
        <c:if test="${totalOrder > 0}">
            <div class="main-card">
                <div class="card">
            ...
            <div class="table-container">
                <div class="table-top">
                    <div class="search-box">
                        <form action="${pageContext.request.contextPath}/admin/orders" method="post" class="choice">
                            ...
                            <button type="submit" name="filter" value="Shipped"
                                class="btn ${requestScope.activeFilter == 'Shipped' ? 'activeBtn' : ''}">Shipped</button>
                            <button type="submit" name="filter" value="Confirmed"
                ...
                <c:if test="${empty orderList}">
                    <p class="no-filter-result">No ${activeFilter} orders found.</p>
                </c:if>
